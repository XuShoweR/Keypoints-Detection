...
DATA_DIR = '/media/roots/data/keypoints_detection/Datasets'
RECORDS_DATA_DIR = '/media/roots/data/keypoints_detection/Datasets/tfrecords'
TEST_RECORDS_DATA_DIR = '/media/roots/data/keypoints_detection/Datasets/tfrecords_test'
TEST_RECORDS_STAGE2 = '/media/roots/data/keypoints_detection/Datasets/tfrecords_test_local'

CATEGORIES = ['blouse', 'dress', 'outwear', 'skirt', 'trousers']
# SPLITS = ['test_0', 'train_1', 'train_2', 'train_3']#'train_0',
SPLITS = ['train', 'test']#'train_0',
WARM_UP_SPLITS = ['train_0']
TRAIN_DIR = ['train']

DEBUG_DIR = '/media/roots/keypoints_detection/Debug'
EVAL_DEBUG_DIR = '/media/roots/keypoints_detection/Eval_Debug'
