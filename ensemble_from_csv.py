...
ensemble_subs = ['seresnext50_cpn_sub_1551239772.csv', 'seresnext50_deconv_cpn_sub_1551935634.csv']
...
def mean_ensemble():
    ...
    df.sort_values('image_id').to_csv(os.path.join(subs_dir, 'ensemble_deconvse_det.csv'), encoding='utf-8', index=False)
