...
tf.app.flags.DEFINE_string(
    'data_dir', '/media/roots/data/keypoints_detection/Datasets/tfrecords',#'/media/rs/0E06CD1706CD0127/Kapok/Chi/Datasets/tfrecords',
    'The directory where the dataset input data is stored.')
tf.app.flags.DEFINE_string(
    'dataset_name', '{}_????', 'The pattern of the dataset name to load.')
tf.app.flags.DEFINE_string(
    'model_dir', './logs_sext_deconv_cpn/',
...
tf.app.flags.DEFINE_integer(
    'tf_random_seed', 20190215, 'Random seed for TensorFlow initializers.')
tf.app.flags.DEFINE_float(
